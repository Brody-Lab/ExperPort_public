...
switch action,
    ...
    if ~strcmp(protocol_list, class(OpenProtocolObject)),
      ...
      if ~isempty(value(protocol_list)),
        ...
        guys = { ...
          'raw_events'                  []    0  ; ... 
          'parsed_events'               []    0  ; ...
          'status_events'               []    0  ; ... %added 09/22/2025
          'full_state_path'             []    0  ; ... %added 09/23/2025
          'all_data_trans'              {}    0  ; ... %added 10/15/2025
          'state_matrix_structure'      []    0  ; ... %added 10/18/2025
          'new_states_trans'            []    0  ; ... %added 10/22/2025
          'SMsendHistoryMatlabTime'     []    0  ; ... %added 11/03/2025
          ...
          'crashed_history'             []    0  ; ...
          'crashed_history_comments'    {}    0  ; ...
          'stitch_chunks_error_history',[]    0  ; ...
          };
      %for explanation of the status_events and full_state_path variables
      %see BpodClientObject case 'GET EVENT COUNTER' opcodes 3 and 4. The 
      %all_data_trans variable stores all data transmitted from the bpod to
      %matlab in a cell, with each transmission its own element in the cell
  ...
  case 'close_protocol',  % ---- CLOSE WHATEVER PROTOCOL IS OPEN. CAN BE USED FROM COMMAND LINE
    %converted block comment to a try catch so it's compatible with bpod rigs
