...
%
% 'get_trialnum_indicator_flag'   Returns the value of the flag
%
...
if nargin==1 && ischar(varargin{1}) && strcmp(varargin{1}, 'init'),
  ...
  SoloParamHandle(obj, 'myfig', ...
      'value', double(figure('Position', [100 100 405 515], 'Name', 'dispatcher')));
...
switch action,
  ...
  case {'get_time', 'is_running', 'get_currentstate', 'get_currentstatenum'},
