...
if isUsingHappenings(sma)
    ...
    for i = 1:nLogicInputChannels
        ...
        standardEvents{standardEventPos} = [BpodSystem.PluginObjects.Bcontrol2Bpod_DI_Map{i},'in'];
        standardEventPos=standardEventPos+1;
        standardEvents{standardEventPos}=[BpodSystem.PluginObjects.Bcontrol2Bpod_DI_Map{i},'out'];
