...
function comscale_edit_Callback(hObject, eventdata, handles)
% hObject    handle to comscale_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of comscale_edit as text
%        str2double(get(hObject,'String')) returns contents of comscale_edit as a double


% --- Executes during object creation, after setting all properties.
function comscale_edit_CreateFcn(hObject, eventdata, handles)
% hObject    handle to comscale_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function comrfid_edit_Callback(hObject, eventdata, handles)
% hObject    handle to comrfid_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of comrfid_edit as text
%        str2double(get(hObject,'String')) returns contents of comrfid_edit as a double
